...
- 2 standard *French* deck (with or without Jokers)

---

## 🧾 **Card Values & Effects**

There are three sets of cards: the *pointed cards*, the *bricks*, and the *royal family*. Some cards give you points while they are face-up on your side of the table. Other cards give you bonus effects **when you *flip* them**. 
...
| Rank      | Effect                                                                                                                                                                          |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Jack**  | **The Sniper** 🔫: You may target a player to add to their *draw pile* **as many cards as you have figures**. The game then proceeds from the player after the targeted player. |
...
\**The King doesn't double the points from the sets, only the pointed cards. You may only have one set of each type.*

---

### The Draw Pile

Every player has their own *draw pile*, a pile of face-down cards that they will draw in future turns. This pile is usually empty, but some cards (T, J) can fill it up pretty quickly, especially if many players target the same person.

Rules:
- If you have cards in your *draw pile*, instead of flipping from the deck, you have to flip from the pile.
- You may not *stay* while you still have cards in your draw pile.

This extra tension makes the player that just flipped a whole bunch of points stay into the hand for a while, adding an exciting factor to the game.
...
2. **STAY**: If you are the point leader, you can decide to *stay*, end your turn, and calculate your score.
