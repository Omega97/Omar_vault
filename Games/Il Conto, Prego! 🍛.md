...
| Turno | Giocatore | Azione              | Dichiarazione          | Rivela |
| ----- | --------- | ------------------- | ---------------------- | ------ |
...
I giocatori sono in grado di comporre la mano chiamata, quindi *il capotavola* (giocatore A) ha fatto la chiamata sbagliata ❌, e ha perso la mano, mentre *il cameriere* (giocatore D) e tutti gli altri hanno vinto la mano.
