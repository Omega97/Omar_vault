...
- Any **quad** (*Revolution*, **highest possible combination**) beats any triple 

So the full sequence of playable strengths is:  
**3 < … < 2 < 33 < … < 22 < 333 < … < 222 < 3333 < … < 2222**

> *Example: 555 (triple 5s) beats KK (pair of Kings), even though K > 5.*

#### **C. Revolution Rule**  
If a player plays **four cards of the same rank** (e.g., four 7s), a **Revolution** occurs immediately:
- The card ranking **reverses**:  
  **2 < A < K < … < 4 < 3** (3 becomes highest, 2 lowest)  
- Jokers remain wild and rank above 3 in Revolution mode.  
- The current trick ends instantly. The player who triggered the Revolution leads the next trick.  
- Each subsequent quad flips the hierarchy back and forth.

> *Tip: Save quads for moments when you hold many low cards—they become powerful!*
...
2. Each subsequent player, in clockwise order, may:  
   ...
   - **Pass** (and sit out the rest of the trick).  
3. When all remaining players pass in succession, the last player to play **wins the trick** and **leads the next one**.
...
If you want to make the game more fun, you may role-play as the character of the corresponding title. For example, the *President* may sit on the most comfy chair, while the *Scum* will sit on the most uncomfortable one, or even on the floor.
